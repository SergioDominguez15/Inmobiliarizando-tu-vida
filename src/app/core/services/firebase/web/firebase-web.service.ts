...
export class FirebaseWebService extends FirebaseService implements OnDestroy{
  ...
  async init(){
    const firebaseConfig = {
      apiKey: "AIzaSyAIhJlX1n3SnF15FWt7EOD3hsLPbda-r2E",
      authDomain: "inmoionic.firebaseapp.com",
      projectId: "inmoionic",
      storageBucket: "inmoionic.appspot.com",
      messagingSenderId: "546272239176",
      appId: "1:546272239176:web:31c0bde028f1b32f4fc27d",
      measurementId: "G-2KQ3Z3GE6B"
    };
